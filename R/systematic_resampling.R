...
systematic_resampling_n <- function(normalized_weights, ndraws){
  return(systematic_resampling_n_(normalized_weights, ndraws))
}

#'@export
systematic_resampling_given_u <- function(normalized_weights, ndraws, u){
  return(systematic_resampling_n_u_(normalized_weights, ndraws, u))
}
